    ...
    <div className="space-y-5">
      ...
      <Section title="Versions">
        <ul className="list-disc pl-4 space-y-1.5">
          ...
          <li>Use the top bar to export the selected version, open history, or undo/redo global edits. Desktop keeps undo across reopen; web keeps undo for the current browser tab</li>
        </ul>
      </Section>
      ...
      <Section title="Logo & favicon">
        <ul className="list-disc pl-4 space-y-1.5">
          ...
          <li>
            <span className="text-text">Apply to all</span> opens a popup (like Group export) to
            copy selected parts of the active variant onto every other variant (one-time, not live
            sync). Choose <span className="text-text">Content</span> (Shape &amp; settings, Colour
            settings, and/or Edit), <span className="text-text">Layer</span> (Inner and/or Outer),
            and <span className="text-text">App</span> (Favicon and/or Logo). Shape &amp; settings
      ...
      <Section title="Paint editor">
        <ul className="list-disc pl-4 space-y-1.5">
          ...
          <li><span className="text-text">Remove brush & eraser</span> clears brush and eraser on the selected layer. With nothing selected it removes the top Brush layer, and stays unavailable when that layer is not there. With every layer selected it clears brush and eraser on all layers. Fill and images stay</li>
