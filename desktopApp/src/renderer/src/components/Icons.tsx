/**
 * Inline SVG icon components that match the lucide-react API surface.
 * Keeping these here instead of importing from lucide-react prevents the
 * 858 KB lucide bundle from being pulled into the eager startup path.
 * lucide-react still loads lazily when the user opens the icon Library tab.
 */
